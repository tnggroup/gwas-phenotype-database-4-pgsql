...
INSERT INTO met.assessment(code,assessment_type,name,abbreviation,reference) VALUES('idpoxfordukbb','imaging','Oxford server/UK Biobank type IDP collection','Oxford IDP assessment',met.get_reference_by_doi('10.1136/bmj.m3871'));
