...
(
    ...
    CONSTRAINT phenotype_population_prevalence_phenotype_assessment_type_fk FOREIGN KEY (phenotype_assessment_type) REFERENCES met.phenotype_assessment_type(code),
